...
Cat.create title: "Siamese", likes: 100, tag: "cute", image: File.open("#{Rails.root}/app/assets/images/Siamese.jpg")
Cat.create title: "Persian", likes: 100, tag: "beautiful", image: File.open("#{Rails.root}/app/assets/images/Persian.jpg")
Cat.create title: "Bengal", likes: 100, tag: "disgusting", image: File.open("#{Rails.root}/app/assets/images/Bengal.jpg")
Cat.create title: "Burmese", likes: 100, tag: "terrifying", image: File.open("#{Rails.root}/app/assets/images/Burmese.jpg")
Cat.create title: "Tabby", likes: 100, tag: "ugly", image: File.open("#{Rails.root}/app/assets/images/Tabby.jpg")
